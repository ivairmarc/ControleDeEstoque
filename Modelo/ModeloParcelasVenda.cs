...
namespace Modelo
{
    public class ModeloParcelasVenda
    {
        public ModeloParcelasVenda()
        {
            ...
            this.PveDataVencito = DateTime.Now;
        }
        ...
        private DateTime pve_datavencito;
        public DateTime PveDataVencito
        {
            get { return this.pve_datavencito; }
            set { this.pve_datavencito = value; }
        }
    }
}
