...
namespace Modelo
{
    ...
    {
        //construtores
        public ModeloFornecedor() //Fortipo 0 -> fisica 1 -> juridica
        {
            this.ForCod = 0;
            this.ForNome = "";
            this.ForCnpj = "";
        ...
        public ModeloFornecedor(int cod, string nome, string cnpj, string ie, string rsocial, string cep, string
            endereco, string bairro, string fone, string celular, string email, string endnumero, string cidade, string estado)
        {
            this.ForCod = cod;
            this.ForNome = nome;
            this.ForCnpj = cnpj;
